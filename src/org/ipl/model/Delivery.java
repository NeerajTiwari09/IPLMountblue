...
public class Delivery {
    ...
    public Integer getWideRun() {
        return wideRun;
    }

    public void setWideRun(Integer wideRun) {
        this.wideRun = wideRun;
    }

    public Integer getByeRun() {
        return byeRun;
    }

    public void setByeRun(Integer byeRun) {
        this.byeRun = byeRun;
    }
    ...
    public void setPenaltyRun(Integer penaltyRun) {
